...
export default function CreateChallan({ triggerAlert, mode }) {
  ...
  return (
    <div className="create-invoice-wrapper">
      <div className="create-invoice-container">
        ...
        <header className="create-invoice-header">
          ...
          <h1 className="create-invoice-header-title">
            {mode === 'Edit' ? 'Edit Delivery Challan' : 'Delivery Challan'}
          </h1>
        </header>
        ...
        <form onSubmit={handleSubmit} id="invoice-form" className="create-invoice-body">
          {loading ? (
            ...
            <>
          {/* Card 1: CHALLAN & CUSTOMER DETAILS */}
          <div className="create-invoice-card">
            <div className="create-invoice-card-header">
              <div className="create-invoice-card-header-left">
                ...
                <h2 className="create-invoice-card-title">CHALLAN & CUSTOMER DETAILS</h2>
              </div>
            </div>
            ...
            <div className="row g-2 mb-3">
              <div className="col-6">
                <label className="create-invoice-label">CHALLAN NUMBER</label>
              ...
              <div className="col-6">
                <label className="create-invoice-label">CHALLAN DATE</label>
                <input
                  type="date"
                  name="bill_date"
            ...
            <div className="create-invoice-field position-relative customer-dropdown-container">
              ...
              <div className="create-invoice-input-wrap">
                <input
                  ...
                  disabled={saving || (mode === 'Edit' && !!invoiceForm.customer && !isEditingCustomer)}
                  autoComplete="off"
                />
                ...
                >
                  {filteredCustomers.length === 0 ? (
                    ...
                    filteredCustomers.map(c => (
                      <li
                        key={c.id}
                        className="d-flex align-items-center justify-content-between px-3 py-2 border-bottom border-light-subtle text-black"
            ...
            <div className="create-invoice-field">
              ...
              <div className="create-invoice-input-wrap">
                ...
                <button
                  ...
                  disabled={saving || isSearchingGst}
                >
            ...
            <div className="create-invoice-field">
              ...
              <textarea
                ...
                name="address"
                className="create-invoice-input"
                placeholder="Enter Billing Address / Factory Gate location"
          ...
          <div className="create-invoice-card">
            <div className="create-invoice-card-header">
              <div className="create-invoice-card-header-left">
                ...
                <h2 className="create-invoice-card-title">DELIVERY ITEMS ({items.length})</h2>
              </div>
              <button 
                type="button" 
          ...
          <div className="create-invoice-card">
            <div className="create-invoice-card-header">
              <div className="create-invoice-card-header-left">
                ...
                <h2 className="create-invoice-card-title">CHARGES & AMOUNT SUMMARY</h2>
              </div>
              <button 
                type="button" 
                className="create-invoice-action-link"
            ...
            <div className="create-invoice-grand-box">
              <div className="create-invoice-grand-left">
                ...
                <p className="create-invoice-grand-sub">Total Challan Value</p>
              </div>
          ...
          {/* Bottom Actions: Clear & Save Delivery Challan */}
          <div className="create-invoice-actions">
            ...
            >
              {saving ? (
                ...
                <>
                  <i className="bi bi-check-circle-fill"></i> Save Delivery Challan
                </>
              )}
            </button>
          </div>
          ...
          <div className={`dashboard-add-modal-container ${extraChargesClosing ? 'closing' : ''}`}>
            ...
            <div className="dashboard-add-modal-body">
              ...
              <div className="bg-light p-3 rounded-3 border mt-1">
                ...
                <div className="mb-2">
                  <label htmlFor="extra-charges-amount-challan" className="dashboard-modal-label mb-1">Amount (₹)</label>
                  <input
                    ref={amountInputRef}
                    type="number"
                    step="0.01"
                ...
                <div className="mb-2">
                  <label htmlFor="extra-charges-reason-challan" className="dashboard-modal-label mb-1">Reason</label>
                  <input
                    type="text"
      ...
      {/* Modal overlay popup for Duplicate Challan Number */}
      {showDuplicateModal && (
        <div className="app-modern-modal-backdrop" onClick={() => setShowDuplicateModal(false)}>
          <div className="app-modern-modal-card" onClick={(e) => e.stopPropagation()}>
            ...
            <h3 className="app-modern-modal-title">Duplicate Challan Number</h3>
            <p className="app-modern-modal-desc">
              The challan number already exists in the system. Please enter a different, unique challan number to save this challan.
            </p>
            <div className="app-modern-modal-pill-box">
              <span className="text-muted fw-semibold" style={{ fontSize: '12px' }}>Challan Number</span>
      ...
      {showClearConfirmModal && (
        <div className="app-modern-modal-backdrop" onClick={() => setShowClearConfirmModal(false)}>
          <div className="app-modern-modal-card" onClick={(e) => e.stopPropagation()}>
            ...
            <h3 className="app-modern-modal-title">Clear Challan Form</h3>
            <p className="app-modern-modal-desc">
              Are you sure you want to clear all form fields? This will discard all your current inputs and reset the form.
            </p>
      ...
      {rowToDelete !== null && (
        <div className="app-modern-modal-backdrop" onClick={() => setRowToDelete(null)}>
          <div className="app-modern-modal-card" onClick={(e) => e.stopPropagation()}>
            ...
            <p className="app-modern-modal-desc">
              Are you sure you want to delete row #{rowToDelete + 1}? This item will be removed from this delivery challan.
            </p>
            <div className="app-modern-modal-pill-box">
      ...
      {customerToDelete !== null && (
        <div className="app-modern-modal-backdrop" onClick={() => setCustomerToDelete(null)}>
          <div className="app-modern-modal-card" onClick={(e) => e.stopPropagation()}>
            ...
            <p className="app-modern-modal-desc">
              Are you sure you want to delete customer "{customerToDelete.name}"? This will remove them from suggestions, but previous challans and bills remain safe.
            </p>
            <div className="app-modern-modal-pill-box">
      ...
      {showExpiryModal && (
        <div className="app-modern-modal-backdrop" onClick={() => setShowExpiryModal(false)}>
          <div className="app-modern-modal-card" onClick={(e) => e.stopPropagation()}>
            ...
            <p className="app-modern-modal-desc">
              Your software license has expired or the challan date exceeds your plan period. Please activate a new license.
            </p>
            <div className="app-modern-modal-pill-box">
              ...
              <div className="d-flex align-items-center gap-3">
                ...
                <div>
                  <h4 className="app-modern-modal-title" style={{ fontSize: '17px', margin: 0 }}>
                    Delivery Challan PDF Live Preview
                  </h4>
                  <span className="text-muted small">
                    Challan #{invoiceForm.bill_number}
                  </span>
                </div>
              </div>
              <button
